...
describe('registerConnectorTools', () => {
  ...
  beforeEach(() => {
    ...
    // Default: getConnector resolves to a non-OData connector, so connector-call-update's
    // OData guard does not trip in tests that don't care about connector type.
    mockSimplifierClient.getConnector.mockResolvedValue({
      connectorType: { technicalName: 'REST', i18n: 'REST', descriptionI18n: '' }
  ...
  describe('connector-call-update tool', () => {
    ...
    describe('tool handler - error handling', () => {
      ...
      it('should reject connector calls for OData connectors', async () => {
        const testParams = {
        ...
        expect(mockSimplifierClient.getConnector).toHaveBeenCalledWith("MyODataConnector", "MCP Tool: connector-call-update", false);
