...
describe('SimplifierClient', () => {
  ...
  describe('getDataTypeByName', () => {
    it('should call getDataTypeByName endpoint with fully qualified datatype id (namespace/name)', async () => {
      ...
      const result = await client.getDataTypeByName('bo/SF_User/getUser_groups_Struct');
    ...
    it('should call getDataTypeByName endpoint with root namespace datatype (no namespace)', async () => {
      ...
      const result = await client.getDataTypeByName('_ITIZ_B_BUS2038_DATA');
    ...
    it('should handle 404 error when datatype not found', async () => {
      ...
      await expect(client.getDataTypeByName('nonexistent/datatype'))
        .rejects
